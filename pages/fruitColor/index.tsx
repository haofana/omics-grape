...
const Metabolism = () =>
{
  ...
  const [activeKey, setActiveKey] = useState('gwasColorFruit')
  // tab分页
  const items = [
    {
      key: 'gwasColorFruit',
  ...
  const [activeColumn, setActiveColumn] = useState(colorFruitColumns);
  useEffect(() => {
    ...
    setActiveColumn(activeKey === 'gwasColorFruit' ? colorFruitColumns : colorPeelColumns);
    fetchGrapeData();
